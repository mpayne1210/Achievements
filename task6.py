...
def primeCheck(num, numList): # This creates a function to calculate if the numbers entered are prime or not, and act accordingly.
...
primeCheck(num, numList) # Calling the primecheck function to sort through the list entered and make its calculations.
